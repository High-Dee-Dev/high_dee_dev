...
function initTerminal() {
  ...
  const commands = {
    ...
    projects: () => [
      ...
      { text: '' },
      { text: '01. Inventory and Sales Management System', cls: 'amber' },
      { text: '    PHP · MySQL · Ajax · Bootstrap', cls: '' },
      { text: '    A complete inventory and sales management system that tracks stock in real time', cls: '' },
      { text: '' },
      { text: '02. Data Analytics Training Program', cls: 'amber' },
      { text: '    JavaScript · Bootstrap · CSS3', cls: '' },
      { text: '    A 12-week program designed to train individuals in practical data analytics skills', cls: '' },
      { text: '' },
      { text: '03. Social Media Preview Tool', cls: 'amber' },
      { text: '    JavaScript · Bootstrap · CSS3', cls: '' },
      { text: '    A tool that lets you paste links and instantly preview social media content', cls: '' },
      { text: '' },
